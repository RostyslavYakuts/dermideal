    ...
    <div class="container mx-auto flex flex-col relative z-10">
        <div class="mt-[110px] l:mt-[168px] flex flex-col justify-center gap-12">
            ...
            <div class="flex flex-col gap-6">
                <p class="text-sm text-brand-green max-w-[480px]">{{$data['description']}}</p>
                <a href="{{$data['cta_link']}}" class="rounded text-white bg-brand hover:bg-brand-hover w-full l:w-[370px] h-[48px] flex justify-center items-center">
                        {{$data['cta_text']}}
                </a>
            </div>
