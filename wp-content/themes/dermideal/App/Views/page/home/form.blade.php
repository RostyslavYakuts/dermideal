...
<section id="contacts_form" class=" container mx-auto form w-full py-[80px] l:py-[120px] relative">
    <div class="mx-auto w-full sm:w-[392px] text-center">
        <h2 class="font-semibold text-[36px] l:text-[48px]">{{$data['form_title']}}</h2>
        <p class="mt-5 text-sm md:text-base text-brand-text">{{$data['form_description']}}</p>
    </div>
    @include('global.form-modal',['data'=>['id'=>'contacts_modal']])
