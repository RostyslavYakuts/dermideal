...
<section class="cases w-full pt-[40px] l:pt-[60px] bg-black py-[40px] l:py-[60px]">
        <div class="container mx-auto">
            <div class="flex justify-between items-center">
                <h2 class="text-white text-[36px] l:text-[48px] ">{{$data['cases_section_title']}}</h2>
                <a class="hidden md:flex justify-center items-center w-[220px] h-[40px] l:h-[60px] bg-brand hover:bg-brand-hover rounded-full text-lg text-white" href="{{$data['cases_section_cta_link']}}">{{$data['cases_section_cta_text']}}</a>
            </div>
        </div>
        <div class="w-full px-[20px]">
            <div class="swiper overflow-hidden cases-container-js mt-[60px] relative">
                <div class="swiper-wrapper relative">
                    @if($data['cases_section_slider'])
                        @foreach($data['cases_section_slider'] as $slide)
                                ...
                                <div class="case-flip-container">
                                    <div class="flip-card flip-card-js">
                                        <div class="side front relative">
                                            ...
                                            <span class="text-white text-[24px] z-10 absolute bottom-[20px] left-[20px]">{{$slide['title']}}</span>
                                        ...
                                        <div class="side back flex flex-col justify-between p-[20px] rounded-[20px]">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <p class="text-brand-text text-sm leading-none">{{$slide['description']}}</p>
                                                <a class="text-brand max-w-[250px]" target="_blank" rel="noreferrer noopener" href="{{$slide['link']}}">{{$slide['link']}}</a>
                                            </div>
            ...
            <a class="mt-[40px] flex md:hidden justify-center items-center w-full h-[48px] xs:w-[220px] xs:mx-auto xs:h-[40px] bg-brand rounded-full text-lg text-white" href="{{$data['cases_section_cta_link']}}">{{$data['cases_section_cta_text']}}</a>
