...
<section class="container mx-auto">
    <div class="flex flex-col gap-[12px] md:flex-row md:justify-between md:items-center">
        ...
        <p class="w-full text-sm l:text-base max-w-[369px] text-brand-text"><?php echo e($data['motivation_section_description']); ?></p>
    </div>
    <div class="arguments-list my-[40px] l:my-[60px] flex flex-col gap-5" >
        <?php if($data['arguments_list']): ?>
            <?php $__currentLoopData = $data['arguments_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $argument = '';
                    if($index === 0){
...
</section><?php /**PATH /var/www/html/wp-content/themes/dermideal/App/Views/page/home/motivation.blade.php ENDPATH**/ ?>