            ...
            <div class="mt-10 swiper new-products-slider">
                <div class="swiper-wrapper">
                    <?php $__currentLoopData = $data['new_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <a class="swiper-slide p-4 border border-brand rounded flex-col gap-3 justify-between items-center" target="_blank" href="<?php echo e(get_permalink($product_id)); ?>">
                            ...
                            >
                            <h3 title="<?php echo e($product->get_name()); ?>" class="text-light-black hover:text-brand text-center text-lg font-semibold line-clamp-4 min-h-[86px]">
                            ...
                            <span class="text-sm text-light-black"><?php echo $product->get_price_html(); ?></span>
...
</section><?php /**PATH /var/www/html/wp-content/themes/dermideal/App/Views/page/shop/new-products.blade.php ENDPATH**/ ?>