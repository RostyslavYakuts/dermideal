...
<section id="about_us" class=" container mx-auto about-us pt-[80px] l:pt-[120px]">
    ...
    <h2 class="text-[38px] l:text-[48px] mt-3 l:max-w-[70%]">
        <?php echo $data['about_us_section_title']; ?>

    </h2>
    <div class="mt-3 w-full flex justify-end">
        <p class="text-brand-text l:max-w-[500px]"><?php echo e($data['about_us_section_description']); ?></p>
    </div>
    <div class="mt-[20px] l:mt-[67px] gap-6 grid grid-cols-2 md:flex md:flex-row md:justify-between md:items-center">
        <?php if($data['about_us_section_statistic']): ?>
            <?php $__currentLoopData = $data['about_us_section_statistic']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex flex-col md:justify-center md:items-center">
                    ...
                    <span class="text-brand-text"><?php echo e($item['title']); ?></span>
                </div>
    ...
    <div class="video-viewport-js mt-[40px] l:mt-[67px] relative">
        <button data-video-src="<?php echo e($data['about_us_section_video']['url']); ?>"
        ...
        <video
                ...
                controls
        ></video>
        <img class="relative z-10 video-bg-js transition-all rounded-[20px] w-full h-auto l:h-[700px] object-cover" width="1170" height="700" loading="lazy" decoding="async" src="<?php echo e($data['about_us_section_video_background']['url']); ?>" alt="<?php echo e($data['about_us_section_video_background']['alt']); ?>">
    </div>

</section><?php /**PATH /var/www/html/wp-content/themes/dermideal/App/Views/page/home/about.blade.php ENDPATH**/ ?>